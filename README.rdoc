...
To begin with, I intend to support the local file systems as well as Amazon S3, and
in compressed .tgz on either the filesystem or S3 interchangeably.
...
Copyright (c) 2009 Joshaven Potter. See LICENSE for details.


=== Contributions
    Anaheim       - Low (SR: 500 - 5,000)
    Jalapeño      - Medium (SR: 2,500-8,000)
    Serrano       - Hot (SR: 10,000-50,000)
    Cayenne       - Hot (SR: 30,000-50,000)
    Habanero      - Exceptionally Hot (SR: 100,000-350,000)
    Naga Jolokia  - Peak (SR: 1,041,427)

If you find that this project is a Serrano or better, please consider donating...