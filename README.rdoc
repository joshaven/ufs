= fsds - File System as a Data Store (Or anything that is FileSystem Like...)

== Notice
This project is under development.  Your welcome to use it but it is NOT
complete and the API is subject to change.
...
jalapeño        - Heat: Medium (SR: 2,500-8,000)
Serrano Pepper  - Heat: Hot (SR: 10,000-50,000)
Habanero        - Heat: Exceptionally Hot (SR: 100,000-350,000)
